...
namespace Nexora.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260901200000_HardenPreCheckpointConcurrency")]
    partial class HardenPreCheckpointConcurrency
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Nexora.Domain.Billing.BillingInvoice", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("CoverageEnd")
                        .HasColumnType("timestamp with time zone");

                    b.Property<DateTimeOffset>("CoverageStart")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("Nexora.Domain.Onboarding.OnboardingDraft", b =>
                {
                    ...
                    b.Property<Guid?>("CompletedTenantId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("CompletedTenantId")
                        .IsUnique()
                        .HasFilter("\"CompletedTenantId\" IS NOT NULL");
            ...
            modelBuilder.Entity("Nexora.Domain.Plans.Plan", b =>
                {
                    ...
                    b.Property<bool>("IsTrialEligible")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("Nexora.Domain.Onboarding.OnboardingDraft", b =>
                {
                    b.HasOne("Nexora.Domain.Tenancy.Tenant", null)
                        .WithMany()
                        .HasForeignKey("CompletedTenantId")
                        .OnDelete(DeleteBehavior.Restrict);
                    ...
                    b.HasOne("Nexora.Domain.Administration.BusinessSegment", null)
                        .WithMany()
