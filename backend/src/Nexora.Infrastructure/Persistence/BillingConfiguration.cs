...
public sealed class SubscriptionConfiguration:IEntityTypeConfiguration<Subscription>
{
    ...
    {
        b.ToTable("subscriptions", DatabaseSchemas.Billing);b.HasKey(x=>x.Id);b.Property(x=>x.Status).HasConversion<string>().HasMaxLength(30);b.Property(x=>x.BillingInterval).HasConversion<string>().HasMaxLength(20);
